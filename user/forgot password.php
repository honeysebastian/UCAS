<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/forgetpsswrd.css">
    </head>
   <body>
    <br><br><br><br><br><br><br><br><br><br>


    <form align="center" action= "./forgotpassword_con.php" method="POST" style='background-color:rgb(240, 124, 88); opacity:0.75;
